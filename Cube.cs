namespace FEM
{
    public class Cube
    {
        ...
        /// </summary>
        public Point Point1 { get; set; } = new Point(-5, -5, 5);
        /// <summary>
        /// Front bottom right point
        /// </summary>
        public Point Point2 { get; set; } = new Point(5, -5, 5);
        /// <summary>
        /// Front top right point
        /// </summary>
        public Point Point3 { get; set; } = new Point(5, 5, 5);
        /// <summary>
        /// Front top left point
        /// </summary>
        public Point Point4 { get; set; } = new Point(-5, 5, 5);
        /// <summary>
        /// Back bottom left point
        /// </summary>
        public Point Point5 { get; set; } = new Point(-5, -5, -5);
        /// <summary>
        /// Back bottom right point
        /// </summary>
        public Point Point6 { get; set; } = new Point(5, -5, -5);
        /// <summary>
        /// Back top right point
        /// </summary>
        public Point Point7 { get; set; } = new Point(5, 5, -5);
        /// <summary>
        /// Back top left point
        /// </summary>
        public Point Point8 { get; set; } = new Point(-5, 5, -5);
    ...
    public class CubeElement : Cube
    {
        ...
        public Point Point12 { get; }
        public Point Point13 { get; }
        public Point Point14 { get; }
        public Point Point15 { get; }
        public Point Point16 { get; }
        public Point Point17 { get; }
        public Point Point18 { get; }
        public Point Point19 { get; }
        public Point Point20 { get; }
